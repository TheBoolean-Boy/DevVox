...
const BillingPage = () => {
  ...
  return (
    <div>
      ...
      <div className=' h-2'></div>
      <div className="bg-gray-50 px-4 py-2 rounded-md border border-green-200 text-gray-700">
        <div className="flex items-center gap-2">
          <Info className='size-4' />
          <p className='text-sm'>Each credit allows you to index 1 file into the Vector Database.</p>
        </div>
